...
namespace System.Threading.Tasks
{
    ...
    public struct TaskLike<TResult> : IEquatable<TaskLike<TResult>>
    {
        ...
        /// <summary>Initialize the <see cref="TaskLike{TResult}"/> with the result of the successful operation.</summary>
        ...
        /// <summary>Returns a value indicating whether this value is equal to a specified <see cref="TaskLike{TResult}"/> value.</summary>
        ...
        /// <summary>Returns a value indicating whether two <see cref="TaskLike{TResult}"/> values are equal.</summary>
        ...
        public static explicit operator TResult(TaskLike<TResult> instance)
        {
        ...
        /// <summary>Gets whether the <see cref="TaskLike{TResult}"/> represents a completed operation.</summary>
        public bool IsCompleted { get { return _task == null || _task.IsCompleted; } }

        /// <summary>Gets whether the <see cref="TaskLike{TResult}"/> represents a successfully completed operation.</summary>
        public bool IsCompletedSuccessfully { get { return _task == null || _task.Status == TaskStatus.RanToCompletion; } }

        /// <summary>Gets whether the <see cref="TaskLike{TResult}"/> represents a failed operation.</summary>
        public bool IsFaulted { get { return _task != null && _task.IsFaulted; } }

        /// <summary>Gets whether the <see cref="TaskLike{TResult}"/> represents a canceled operation.</summary>
        ...
        /// </param>
        public ConfiguredTaskLikeAwaitable<TResult> ConfigureAwait(bool continueOnCapturedContext)
        {
            return new ConfiguredTaskLikeAwaitable<TResult>(this, continueOnCapturedContext: continueOnCapturedContext);
        }

        /// <summary>Gets a string-representation of this <see cref="TaskLike{TResult}"/>.</summary>
        ...
        public static AsyncTaskLikeMethodBuilder<TResult> CreateAsyncMethodBuilder() => AsyncTaskLikeMethodBuilder<TResult>.Create();
    }
}
