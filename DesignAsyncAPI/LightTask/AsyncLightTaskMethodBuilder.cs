...
{
    /// <summary>Represents a builder for asynchronous methods that returns a <see cref="LightTask{TResult}"/>.</summary>
    /// <typeparam name="TResult">The type of the result.</typeparam>
    [StructLayout(LayoutKind.Auto)]
    public struct AsyncLightTaskMethodBuilder<TResult>
    {
        ...
        /// <summary>Creates an instance of the <see cref="AsyncLightTaskMethodBuilder{TResult}"/> struct.</summary>
        /// <returns>The initialized instance.</returns>
        public static AsyncLightTaskMethodBuilder<TResult> Create() =>
            new AsyncLightTaskMethodBuilder<TResult>() { _methodBuilder = AsyncTaskMethodBuilder<TResult>.Create() };
        ...
        public LightTask<TResult> Task
        {
            get
            {
                if (_haveResult)
                {
                    return new LightTask<TResult>(_result);
                }
                else
                {
                    _useBuilder = true;
                    return new LightTask<TResult>(_methodBuilder.Task);
                }
            }
        }
